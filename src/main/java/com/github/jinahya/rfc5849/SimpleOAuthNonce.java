...
public class SimpleOAuthNonce implements OAuthNonce {
    ...
    /**
     * Creates a new instance which generates nonce values with given identifiers as a prefix.
     *
     * @param identifiers identifies for specifying client such as device or agent identifier.
    ...
    /**
     * {@inheritDoc} This methods returns the value of {@link Random#nextLong()} invoked on what {@link #random()}
     * returns.
     *
     * @return {@inheritDoc}
     */
