 ...
 */
public class SignatureBuilderRsaSha1Jc
    ...
    @Override
    public SignatureBuilderRsaSha1Jc privateKey(final PrivateKey privateKey) {
        return (SignatureBuilderRsaSha1Jc) super.privateKey(privateKey);
    }
